...
export default function Header() {
  ...
  const handlAddNewCard = () => {
    if (
      cardFormValues.Bucket_id !== "" &&
      cardFormValues.CardName !== "" &&
      cardFormValues.Link !== "" &&
      cardFormValues.LinkType !== ""
    ) {
  ...
  return (
    <>
      ...
      {/* modal */}
      <Modal open={openBucketModal} onClose={handleClose}>
        <Box sx={style}>
          ...
          >
            <Button variant="contained" onClick={handlAddBucketName}>
              Create
            </Button>
          </Box>
        </Box>
      ...
      {/* card modal */}
      <Modal open={openCardModal} onClose={handleClose}>
        <Box sx={style}>
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Create new card
          </Typography>
          ...
          >
            <Button variant="contained" onClick={handlAddNewCard}>
              Create
            </Button>
          </Box>
        </Box>
