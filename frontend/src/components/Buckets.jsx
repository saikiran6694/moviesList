...
const Buckets = ({ list }) => {
  ...
  const [updateBucketNameFormValues, setUpdateBucketNameFormValues] =
  ...
  const updateBucketName = (e) => {
    ...
    setUpdateBucketNameFormValues({
      ...updateBucketNameFormValues,
      [name]: value,
    });
  };
    ...
    <>
      ...
      <Modal open={open} onClose={handleClose}>
        <Box sx={style}>
          ...
          >
            <Button variant="contained" onClick={handleUpdateBucketName}>
              Update
            </Button>
          </Box>
        </Box>
